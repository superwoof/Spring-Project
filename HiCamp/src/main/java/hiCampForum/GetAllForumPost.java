...
@WebServlet("/GetAllForumPost")
public class GetAllForumPost extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.getRequestDispatcher("/forum/ForumUserHomepage.jsp").forward(request, response);
