...
%>
 ...
 <aside>
    ...
    <div class="camp-info">
        <p><span class="info-label">營區編號:</span> ${camp.campsiteNo}</p>
        <p><span class="info-label">營區名稱:</span> ${camp.campsiteName}</p>
        <p><span class="info-label">營區數量:</span> ${camp.campsiteQuantity}</p>
        <p><span class="info-label">營區位置:</span> ${camp.campsiteLocation}</p>
        <p><span class="info-label">營區資訊:</span> ${camp.campsiteInfo}</p>
    </div>
</c:if>
