...
<h3>新增營區</h3>
<div align="center" style="margin-bottom:31vh">
<form method="post" action="../AddCamp">
	輸入營區編號 : <input type="text" name="campsiteNo" /><p><br>
	輸入營區名稱 : <input type="text" name="campsiteName" /><p><br>
	輸入營區數量 : <input type="text" name="campsiteQuantity" /><p><br>
	輸入營區地點 : <input type="text" name="campsiteLocation" /><p><br>
	輸入營區資訊 : <input type="text" name="campsiteInfo" /><p><br>
