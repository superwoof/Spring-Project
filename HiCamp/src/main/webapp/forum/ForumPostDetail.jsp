...
<body>
            ...
            <article>
                <div class="container">
                    ...
                    <form action="InsertForumComment" method="post">
                        <input type="hidden" name="forumNo" value="${forum.forumNo}">
                        <label for="forumComment">請輸入內容:</label>
                        <input type="text" name="forumComment" required autocomplete="off">
                    ...
                    <c:forEach var="comment" items="${comments}">
                        <div class="card">
                            <div class="card-body">
                                ...
                                ${comment.forumCommentDate}
                                <div>
                                    <button type="button" class="btn btn-primary"
                                        onclick="showUpdateForm('${comment.forumCommentNo}')">修改</button>
                                    <form id="update-form-${comment.forumCommentNo}" action="UpdateForumComment"
                                        method="post" style="display: none;">
                                        <input type="hidden" name="forumNo" value="${forum.forumNo}">
                                        <input type="hidden" name="forumCommentNo" value="${comment.forumCommentNo}">
                                        <label for="updatedComment">輸入修改內容:</label>
                                        <input type="text" id="updatedComment" name="updatedForumComment" required
                                            autocomplete="off">
                                        <button type="submit" class="btn btn-primary">保存</button>
                                    </form>
                                    <form action="DeleteForumComment" method="post" style="display: inline;">
                                        <input type="hidden" name="forumCommentNo" value="${comment.forumCommentNo}">
                                        <input type="hidden" name="forumNo" value="${forum.forumNo}">
    ...
    <script>
        function showUpdateForm(commentNo) {
            document.getElementById('update-form-' + commentNo).style.display = 'block';
        }
    </script>
</body>
