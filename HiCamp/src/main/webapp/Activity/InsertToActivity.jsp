...
<head>
<meta charset="UTF-8">
<jsp:useBean id="activity" scope="request" class="hiCampBean.ActivityBean" />
		...
		<div class="content">
			...
			<div class="bar">
				...
				<table
					...
					<tr
						style="margin-left: 0; font-size: 120%; justify-content: space-between;">
						<td><button
								onclick="location.href='/HiCamp/Activity/InsertToActivityData.jsp'"
								style="font-size: 120%;">繼續新增</button></td>
						<td><button
								onclick="location.href='/HiCamp/Activity_SelectAll'"
								style="font-size: 120%;">查看活動列表</button></td>
					</tr>
			...
			<footer>
				<div class="infomation">
					<h2>
						<a href="./project2.html"><img src="/HiCamp/Activity/images/logo.jpg"
							alt="logo"></a>
					</h2>
					<ul>
						<li>復興南路390號</li>
