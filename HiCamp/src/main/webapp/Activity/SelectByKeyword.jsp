...
<script>
	function deleteActivity(activityNo) {
		if (confirm("確定要刪除此活動嗎？")) {
			location.href = "http://localhost:8080/Project_Hiking/Activity/DeleteActivity?activityNo="
					+ activityNo;
		}
	}
</script>
					...
					<table>
						<tr>
							...
							<th style="border: none; text-align: left;"><button
									...
									class="btn-searchall">顯示所有活動</button></th>
